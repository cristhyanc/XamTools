...
namespace XamTools.StarRating
{
    ...
    {
        public event EventHandler ItemBehaviorSelectedEvent;
        //     public event EventHandler<bool> IsStarredChangedEvent;
        public object CustomerItem { get; set; }
        ...
        public bool IsStarred
        {
            set
            {
                ...
                //EventHandler<bool> handler = IsStarredChangedEvent;
        ...
        static void OnIsStarredChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if ((bool)newValue)
            {
                ...
                // StarBehavior preItem= behaviors.FirstOrDefault();
                foreach (var item in behaviors)
                {
                    ...
                    if (item != behavior && itemReached)
                    {
                        ...
                        EventHandler handler = behavior.ItemBehaviorSelectedEvent;

                        if (handler != null)
                        {
                            handler(behavior, null);
                        }
                    }
